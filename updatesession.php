...
class updatesession extends \moodleform {
    ...
    public function definition() {
        ...
        if (!empty($studentscanmark)) {
            ...
            echo '    var autoAssignStatus = document.querySelector("#id_autoassignstatus");';
            echo '    if (autoAssignStatus) {';
            echo '        var parentDiv = autoAssignStatus.closest(".form-group.row.fitem");';
            echo '        if (parentDiv) {';
            echo '            parentDiv.style.display = "none";';
            echo '        }';
            echo '    }';
            echo '});';
            echo '</script>';
